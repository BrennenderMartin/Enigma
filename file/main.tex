...
\section{Die Enigma\,-\,Maschine}
    Die Enigma\,-\,Maschine ist eine Chiffriermaschine, die durch die Nutzung von Permutation und Subststution der Buchstaben eine Nachricht Buchstabe für Buchstabe verschlüsselt.
...
\subsection{Wie die Enigma\,-\,Maschine funktioniert}
    ...
    Japan hatte aber dafür die Lösung, da sie bei ihrer Version der Enigma\,-\,Maschine nicht eine, sondern fünf Übertragungskerben hatten, welche diese Enigma\,-\,Maschine stärker machte als die in Deutschland am meisten verbreiteten Enigma\,-\,Maschinen (\emph{Enigma-T} oder auch \emph{Tirpitz} genannt \cite{Tirpitz}). 
    Aber auch in Deutschland gab es Enigma\,-\,Maschine mit mehreren Übertragungskerben, da die Abwehr\,-\,Enigma (G) bis zu 17 Übertragungskerben hatte.
